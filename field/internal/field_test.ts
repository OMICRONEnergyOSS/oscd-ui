...
declare global {
  interface HTMLElementTagNameMap {
    'oscd-test-field': TestField;
  }
}

@customElement('oscd-test-field')
...
describe('Field', () => {
  ...
  async function setupTest(props: Partial<Field> = {}) {
    ...
    const instance = root.querySelector('oscd-test-field');
    if (!instance) {
      throw new Error('Could not query rendered <oscd-test-field>.');
    }
