...
export abstract class Select extends selectBaseClass {
  ...
  /**
   * Whether or not the underlying oscd-menu should be position: fixed to display
   * in a top-level manner, or position: absolute.
   *
   * position:fixed is useful for cases where select is inside of another
   * element with stacking context and hidden overflows such as `oscd-dialog`.
   */
   ...
   *
   * NOTE: oscd-select only supports single selection.
   */
  get selectedOptions() {
  ...
  @query('oscd-menu') private readonly menu!: Menu | null;
  ...
  /**
   * Selects an option given the value of the option, and updates OscdSelect's
   * value.
   */
  select(value: string) {
  ...
  /**
   * Selects an option given the index of the option, and updates OscdSelect's
   * value.
   */
