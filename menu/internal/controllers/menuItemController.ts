 ...
 * should implement this interface to be compatible with oscd-menu. Additionally
 * it should have the `oscd-menu-item` attribute set.
 *
...
export class MenuItemController implements ReactiveController {
  ...
  hostConnected() {
    this.host.toggleAttribute('oscd-menu-item', true);
  }
