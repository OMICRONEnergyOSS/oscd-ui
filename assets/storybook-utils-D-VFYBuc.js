import{x as r,a as m}from"./iframe-BFpCwY9R.js";import{b as h,n}from"./list-item-styles-Bfc4eJrR.js";import{O as u}from"./OscdCheckbox-CUAXXZLT.js";import{O as f}from"./OscdRadio-BE423v1M.js";import{O as g,a as y}from"./OscdListItem-B_3Vgj5Y.js";import{O as x}from"./OscdList-XsnvtwlT.js";import{O as C}from"./OscdOutlinedTextField-C_3bodT-.js";import{F as b}from"./FilterListBase-u3mEvX3v.js";var E=Object.defineProperty,v=Object.getOwnPropertyDescriptor,p=(t,e,s,c)=>{for(var o=c>1?void 0:c?v(e,s):e,l=t.length-1,i;l>=0;l--)(i=t[l])&&(o=(c?i(e,s,o):i(o))||o);return c&&o&&E(e,s,o),o};function O(t){return r`<oscd-checkbox
    slot="start"
    ?checked=${t.selected}
    ?disabled=${t.disabled}
  ...
  ></oscd-radio>`}const a=class a extends b{constructor(){super(...arguments),this.multiselect=!1,this.items=[]}get selectedElements(){const e=[];return this.items.forEach(s=>{s.selected&&s.attachedElement&&e.push(s.attachedElement)}),e}renderListItem(e){return r`<oscd-list-item
    ...
    >
      ...
      >
    </section>`}};a.scopedElements={"oscd-outlined-text-field":C,"oscd-icon":y,"oscd-list":x,"oscd-list-item":g,"oscd-checkbox":u,"oscd-radio":f},a.styles=m`
    section {
      display: flex;
  ...
  `;let d=a;p([n({type:Boolean})],d.prototype,"multiselect",2);p([n({type:Array})],d.prototype,"items",2);p([n({type:Array})],d.prototype,"selectedElements",1);function S(t,e){return new CustomEvent("selection-list-change",{bubbles:!0,composed:!0,...e,detail:{selectedElements:t,...e?.detail}})}const _=new DOMParser().parseFromString(`<SCL>
...
</SCL>`,"application/xml");export{d as O,_ as s};
