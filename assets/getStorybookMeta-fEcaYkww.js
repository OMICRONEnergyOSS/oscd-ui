import{x as a,i as C,E as r,a as y}from"./iframe-C4uLaTi3.js";import{g as s,s as O}from"./getStorybookHelpers-BPPERp-C.js";import"./oscd-menu-item-D6eVNoir.js";import{a as I,c as T}from"./OscdIcon-C3sU6W8j.js";import{m as k,_ as n,n as l,b as E,S as M,O as D}from"./list-navigation-helpers-uOLGipP7.js";import"./oscd-filled-button-CEBWtmCm.js";import{O as A}from"./OscdList-C90geFFa.js";const F={"oscd-branded-fab":{argTypes:{label:{name:"Label Text",control:{type:"text"},description:"Label text shown next to the FAB"},variant:{options:["surface","primary","secondary","tertiary"],control:{type:"select"}},icon:{name:"Icon Name",control:{type:"text"},description:"Material Icon name"}},args:{label:"Branded Fab Button",icon:"edit",variant:"primary"},meta:{render:({label:e,icon:t,...o})=>{const{template:i}=s("oscd-branded-fab");return a`
          <style>
            label {
              display: flex;
