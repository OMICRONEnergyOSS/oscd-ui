import{i as e}from"./preload-helper-xPQekRTU.js";import{T as t,b as n,f as r,h as i,u as a}from"./static-html-JNahc6jH.js";import{I as o,L as s,_ as c,j as l,k as u}from"./list-navigation-helpers-C1Ibc9kd.js";import{A as d,E as ee,T as te,j as ne,n as re,t as f}from"./OscdIcon-BLAkUGod.js";import{n as p,t as m}from"./decorate-DTsqE9Ek.js";import{n as ie}from"./oscd-menu-item-CTcQZDW2.js";import{n as ae,t as oe}from"./getStorybookMeta-BOUCYHqO.js";import{n as se,t as ce}from"./OscdCheckbox-CJxI8LRI.js";import{t as le}from"./oscd-outlined-text-field-D5_W7q22.js";var h,ue=e((()=>{a(),c(),p(),h=class extends r{constructor(...e){super(...e),this.selected=!1,this.active=!1,this.disabled=!1,this.hasLeadingContent=!1}connectedCallback(){super.connectedCallback(),this.hasLeadingContent=this.querySelector(`[slot="start"]`)!==null}handleStartSlotChange(e){this.hasLeadingContent=e.target.assignedElements({flatten:!0}).length>0}render(){return n`<div part="content" class="content">
      <span
        part="leading"
...
>
  ...
  />
    ...
    >
      ...
      ></oscd-tree>
    </div>`}},Q={args:{selectedIdsByTree:{}},render:e=>{let[t,r]=T(),i=e.selectedIdsByTree??{},a=e=>{let t=e.currentTarget.parentElement?.querySelector(`oscd-tree`);t&&(t.activeId=t.getFirstNodeId(),t.focus())},o=e=>{let t=e.currentTarget,n=e.detail.direction,r=Array.from(t.parentElement?.querySelectorAll(`oscd-tree`)??[]),i=r[r.indexOf(t)+(n===`last`?1:-1)];i&&(i.activeId=n===`last`?i.getFirstNodeId():i.getLastNodeId(),i.focus())},s=(e,t)=>{L(t),r({selectedIdsByTree:{...i,[e]:t.detail.selectedIds}})},c=e=>n`<oscd-tree
        .data=${[{id:`${e}:one`,label:`${e} / One`,children:[]},{id:`${e}:two`,label:`${e} / Two`,children:[]}]}
        selectionMode="single"
        .selectedIds=${i[e]??[]}
        .renderItem=${N}
        @navigation-boundary=${o}
        @selected-ids-changed=${t=>s(e,t)}
    ...
    >
      ...
      <button type="button" @click=${a}>Focus first tree</button>
      ${c(`Tree A`)} ${c(`Tree B`)}
      ${c(`Tree C`)}
  ...
  render: argz => {
    const [_, updateArgs] = useArgs();
    const selectedIdsByTree = argz['selectedIdsByTree'] as Record<string, string[]> ?? {};
    ...
    const handleStackedSelection = (prefix: string, event: CustomEvent<TreeSelectionChangeEventDetail<DemoTreeNode>>) => {
    ...
    const renderStackedTree = (prefix: string) => html\`<oscd-tree
      ...
      children: []
        ...
        @selected-ids-changed=\${(event: CustomEvent<TreeSelectionChangeEventDetail<DemoTreeNode>>) => handleStackedSelection(prefix, event)}
      ></oscd-tree>\`;
    return html\`<div
      class="stacked-tree-story"
      style="display: flex; flex-direction: column; justify-self:center; gap: 8px; width: min(520px, 100%);"
