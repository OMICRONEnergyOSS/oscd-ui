import{i as e}from"./preload-helper-xPQekRTU.js";import{T as t,b as n,f as r,u as i}from"./static-html-JNahc6jH.js";import{I as a,L as o,_ as s,j as c,k as l}from"./list-navigation-helpers-C1Ibc9kd.js";import{n as u,t as d}from"./OscdIconButton-DuPgxA44.js";import{n as f,t as p}from"./decorate-DTsqE9Ek.js";import{n as m,t as h}from"./getStorybookMeta-Ddn_OaDx.js";function g(e){let t=0,n=e=>{e&&(e.leaf&&e.leaf.length&&(t=Math.max(t,e.leaf.length)),e.children?.forEach(n))};return n(e),t}var _,v=e((()=>{i(),s(),o(),u(),f(),_=class extends a(r){constructor(...e){super(...e),this.data=null,this.folded=new Set,this.knownPaths=new Set,this.maxLeafCols=0}static{this.scopedElements={"oscd-icon-button":d}}pathKey(e){return e.join(`.`)||`root`}willUpdate(e){if(this.data){let e=new Set,t=(n,r=[])=>{if(n){if(r.length>0&&n.children!==void 0){let t=this.pathKey(r);e.add(t)}n.children?.forEach((e,n)=>t(e,[...r,`children`,n]))}};t(this.data,[]);let n=new Set(this.folded);e.forEach(e=>{this.knownPaths.has(e)||n.add(e)});let r=new Set;n.forEach(t=>{e.has(t)&&r.add(t)}),this.folded=r,this.knownPaths=e,this.maxLeafCols=g(this.data)}}toggleFold(e,t){let n=this.pathKey(e),r=new Set(this.folded),i=r.has(n);r.has(n)?r.delete(n):r.add(n),this.folded=r,this.requestUpdate(),i&&t&&t.leaf===void 0&&Array.isArray(t.children)&&t.children.length===0&&this.dispatchEvent(new CustomEvent(`unfold`,{detail:t,bubbles:!0,composed:!0}))}renderLeadingIcon(e){return e.icon instanceof SVGElement?n`<span class="leading-icon">${e.icon}</span>`:typeof e.icon==`string`?n`<span class="leading-icon ms">${e.icon}</span>`:n``}renderRows(e,t=[],r=0,i=!1){if(!e)return[];let a=[],o=e.children!==void 0,s=!!(e.children&&e.children.length>0),c=this.pathKey(t),l=this.folded.has(c),u=e.leaf??[];return a.push(n`
  ...
  `}},p([c({type:Object})],_.prototype,`data`,void 0),p([l()],_.prototype,`folded`,void 0),p([l()],_.prototype,`knownPaths`,void 0),p([l()],_.prototype,`maxLeafCols`,void 0)})),y=e((()=>{v(),customElements.define(`oscd-action-tree`,_)})),b,x,S,C,w,T,E;e((()=>{y(),m(),b={name:`IED1`,children:[{name:`LD1`,children:[{name:`LLN0`,children:[{name:`Beh`,leaf:[{val:0},{edit:()=>{window.alert(`SomeAlert`)},val:1},{val:4}]}]},{name:`MMXU1`,info:`This is a logical node for measurement`,children:[{name:`A`,children:[{name:`phsA`,leaf:[{val:33.44},{val:55.4483482345},{val:66.44}]},{name:`phsB`,leaf:[{val:22.44},{val:66.44},{val:77.44}]},{name:`phsC`,leaf:[{val:11.44},{val:33.44},{val:55.44}]}]}]}]},{name:`LD2`,children:[{name:`LLN0`,children:[{name:`Beh`,leaf:[{val:0}]}]},{name:`MMXU1`,children:[{name:`A`,children:[{name:`phsA`,leaf:[{val:33.44},{val:55.44},{val:66.44}]},{name:`phsB`,leaf:[{val:22.44},{val:66.44},{val:77.44}]},{name:`phsC`,leaf:[{val:11.44},{val:33.44},{val:55.44}]}]}]}]},{name:`LD3`,children:[]}]},{args:x,argTypes:S,meta:C}=h({tagName:`oscd-action-tree`}),w={title:`Action Controls/Action Tree`,tags:[`autodocs`],...C},T={argTypes:S,args:{...x,".data":b}},T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  argTypes,
  args: {
    ...args,
    ['.data']: sampleData
