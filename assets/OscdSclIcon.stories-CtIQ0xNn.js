import{e as l,S as r}from"./OscdListItem-B_3Vgj5Y.js";import{g as a}from"./getStorybookMeta-gDO-wW0N.js";import{x as c}from"./iframe-BFpCwY9R.js";import"./list-item-styles-Bfc4eJrR.js";import"./getStorybookHelpers-cc4YvQDR.js";import"./oscd-menu-item-COy5XFsF.js";import"./OscdMenuItem-DnbnThgq.js";import"./query-assigned-nodes-Ud0G1qU0.js";import"./OscdList-XsnvtwlT.js";import"./preload-helper-PPVm8Dsz.js";customElements.define("oscd-scl-icon",l);const{args:i,argTypes:d,meta:p}=a({tagName:"oscd-scl-icon"}),u={...p,title:"Icons / SCL Icon",tags:["autodocs"]},e={argTypes:{textContent:{options:Object.keys(r),control:{type:"select"},description:"SCL Icon to be displayed."},...d},args:{...i,textContent:i.textContent??"elementIcon"},render:({textContent:n,...s})=>c`<div>
      <style>
        .standard {
          --md-icon-size: 24px;
        }
...
}`,...o.parameters?.docs?.source}}};const I=["Default","AllIcons"];export{o as AllIcons,e as Default,I as __namedExportsOrder,u as default};
