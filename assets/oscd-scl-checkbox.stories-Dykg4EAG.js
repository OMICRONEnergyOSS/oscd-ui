import{i as m,x as h,a as b}from"./iframe-D_AT4TIz.js";import{S as x,n as i,a as g}from"./list-item-styles-B8z8P4EW.js";import{r as n}from"./OscdListItem-Dtz4smBz.js";import{O as f}from"./OscdCheckbox-8YMHiqKe.js";import{O as y}from"./OscdSwitch-DScFHJxS.js";import{g as w}from"./getStorybookMeta-DSrCqPZ2.js";import"./preload-helper-PPVm8Dsz.js";import"./OscdMenuItem-BwTzKIea.js";import"./query-assigned-nodes-BPJpqv7A.js";import"./redispatch-event-D1qO1AWI.js";import"./validator-B2hqroGq.js";import"./form-associated-CDMYVxQk.js";import"./checkbox-validator-CWIo2DWx.js";import"./getStorybookHelpers-BPhoQ4a6.js";import"./oscd-menu-item-BRx5nmZc.js";import"./OscdList-Diogj996.js";var k=Object.defineProperty,V=Object.getOwnPropertyDescriptor,s=(d,t,u,r)=>{for(var l=r>1?void 0:r?V(t,u):t,p=d.length-1,c;p>=0;p--)(c=d[p])&&(l=(r?c(t,u,l):c(l))||l);return r&&l&&k(t,u,l),l};const o=class o extends x(m){constructor(){super(...arguments),this.nullable=!1,this.checkboxValue="false",this.disabled=!1,this.label="",this.supportingText="",this.isNull=!1,this.parkedValue=null}set value(t){t===null?this.null=!0:(this.null=!1,this.checkboxValue=t)}get value(){return this.null?null:this.checkboxValue}get userText(){return`${this.label}${this.supportingText!==""?` (${this.supportingText})`:""}`}get null(){return this.nullable&&this.isNull}set null(t){!this.nullable||t===this.isNull||(this.isNull=t,this.isNull?(this.parkedValue=this.checkboxValue,this.defaultValue&&(this.checkboxValue=this.defaultValue)):(this.checkboxValue=this.parkedValue,this.parkedValue=null))}reportValidity(){return!0}checkValidity(){return!0}renderNullSwitch(){return this.nullable?h`<oscd-switch
