import{i as $,E as g,x as n,a as b}from"./iframe-C4uLaTi3.js";import{S as f,b as x,n as l}from"./list-navigation-helpers-uOLGipP7.js";import{O as w}from"./OscdIcon-C3sU6W8j.js";import{g as L}from"./getStorybookMeta-fEcaYkww.js";import"./preload-helper-PPVm8Dsz.js";import"./getStorybookHelpers-BPPERp-C.js";import"./oscd-menu-item-D6eVNoir.js";import"./OscdListItem-CcUpt_sr.js";import"./list-item-styles-CwxrGOCZ.js";import"./OscdMenuItem-AVFwwFRE.js";import"./query-assigned-nodes-EHSBqaR2.js";import"./menuItemController-vk-DquCy.js";import"./oscd-filled-button-CEBWtmCm.js";import"./OscdList-C90geFFa.js";var E=Object.defineProperty,s=(o,e,i,t)=>{for(var c=void 0,h=o.length-1,v;h>=0;h--)(v=o[h])&&(c=v(e,i,c)||c);return c&&E(e,i,c),c};function m(o,e){const i=o.nodeType===Node.ELEMENT_NODE?o.closest(e):null;if(i)return i;const t=o.getRootNode();return t instanceof ShadowRoot?m(t.host,e):null}const p=class p extends f($){constructor(){super(...arguments),this.secondary=!1,this.highlighted=!1,this.level=1}connectedCallback(){super.connectedCallback(),this.tabIndex=0,this.parentPane=m(this.parentNode,"oscd-action-pane")??void 0}get resolvedLevel(){const e=this.parentPane?this.parentPane.resolvedLevel+1:this.level;return Math.floor(e)}renderHeader(){const e=n`<span
        ><slot name="icon"
  ...
  `;let a=p;s([l({type:String})],a.prototype,"label");s([l({type:String})],a.prototype,"icon");s([l({type:Boolean})],a.prototype,"secondary");s([l({type:Boolean})],a.prototype,"highlighted");s([l({type:Number})],a.prototype,"level");window.customElements.define("oscd-action-pane",a);const{args:u,argTypes:y,meta:S}=L({tagName:"oscd-action-pane"}),q={title:"Action Controls/Action Pane",tags:["autodocs"],...S},d={argTypes:y,args:u,render:({label:o,icon:e})=>n`<div>
...
}`,...r.parameters?.docs?.source}}};const z=["CalculatedLevels","DefinedLevels"];export{d as CalculatedLevels,r as DefinedLevels,z as __namedExportsOrder,q as default};
