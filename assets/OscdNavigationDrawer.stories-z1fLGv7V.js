import{x as s}from"./iframe-CED9u4fv.js";import{O as i}from"./OscdNavigationDrawer-DbQiD4q7.js";import{O as d}from"./OscdList--At7ZW1p.js";import{a as n,O as c}from"./OscdListItem-YzTXxYva.js";import{s as l}from"./scopedWcDecorator-sgJzn6lB.js";import{O as p}from"./OscdAppBar-Ba1a8A3M.js";import{O as m}from"./OscdFilledIconButton-CDck-bl9.js";import{O as g}from"./OscdNavigationDrawerHeader-Crtd6-cf.js";import"./preload-helper-PPVm8Dsz.js";import"./list-item-styles-DbtL1MIB.js";import"./shared-styles-DxA7yIRS.js";import"./is-rtl-DJNyvqXe.js";const{useArgs:v}=__STORYBOOK_MODULE_PREVIEW_API__,{action:u}=__STORYBOOK_MODULE_ACTIONS__,x={title:"Navigation Drawer/Navigation Drawer",component:"oscd-navigation-drawer",tags:["autodocs"],decorators:[l],parameters:{layout:"fullscreen",scopedElements:{"oscd-navigation-drawer":i,"oscd-navigation-drawer-header":g,"oscd-app-bar":p,"oscd-list":d,"oscd-list-item":c,"oscd-filled-icon-button":m,"oscd-icon":n}},argTypes:{label:{control:{type:"text"},description:"Navigation drawer Header label"},opened:{control:{type:"boolean"},description:"Menu opened state"}},render:({label:t,opened:r})=>{const[O,e]=v();return s`
      <style>
        oscd-app-bar {
