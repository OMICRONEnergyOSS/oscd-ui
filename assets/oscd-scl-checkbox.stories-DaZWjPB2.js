import{i as m,x as h,a as b}from"./iframe-BFpCwY9R.js";import{S as x,n as i,a as g}from"./list-item-styles-Bfc4eJrR.js";import{r as n}from"./OscdListItem-B_3Vgj5Y.js";import{O as f}from"./OscdCheckbox-CUAXXZLT.js";import{O as y}from"./OscdSwitch-exgAMmls.js";import{g as w}from"./getStorybookMeta-gDO-wW0N.js";import"./preload-helper-PPVm8Dsz.js";import"./OscdMenuItem-DnbnThgq.js";import"./query-assigned-nodes-Ud0G1qU0.js";import"./redispatch-event-D1qO1AWI.js";import"./validator-C3KVGDlf.js";import"./form-associated-qER_3PrR.js";import"./checkbox-validator-CQVrzvKL.js";import"./getStorybookHelpers-cc4YvQDR.js";import"./oscd-menu-item-COy5XFsF.js";import"./OscdList-XsnvtwlT.js";var k=Object.defineProperty,V=Object.getOwnPropertyDescriptor,s=(d,t,u,r)=>{for(var l=r>1?void 0:r?V(t,u):t,p=d.length-1,c;p>=0;p--)(c=d[p])&&(l=(r?c(t,u,l):c(l))||l);return r&&l&&k(t,u,l),l};const o=class o extends x(m){constructor(){super(...arguments),this.nullable=!1,this.checkboxValue="false",this.disabled=!1,this.label="",this.supportingText="",this.isNull=!1,this.parkedValue=null}set value(t){t===null?this.null=!0:(this.null=!1,this.checkboxValue=t)}get value(){return this.null?null:this.checkboxValue}get userText(){return`${this.label}${this.supportingText!==""?` (${this.supportingText})`:""}`}get null(){return this.nullable&&this.isNull}set null(t){!this.nullable||t===this.isNull||(this.isNull=t,this.isNull?(this.parkedValue=this.checkboxValue,this.defaultValue&&(this.checkboxValue=this.defaultValue)):(this.checkboxValue=this.parkedValue,this.parkedValue=null))}reportValidity(){return!0}checkValidity(){return!0}renderNullSwitch(){return this.nullable?h`<oscd-switch
