import{i as e}from"./preload-helper-xPQekRTU.js";import{T as t,b as n,f as r,h as i,u as a}from"./static-html-JNahc6jH.js";import{F as o,I as s,L as c,M as l,N as u,P as d,_ as f,f as ee,h as te,j as p,m as ne,p as re}from"./list-navigation-helpers-C1Ibc9kd.js";import{C as ie,v as ae,w as oe,y as se}from"./OscdIcon-CDSDekmX.js";import{n as ce,t as le}from"./OscdList-BWC_Wr9e.js";import{n as m,r as ue,t as h}from"./getStorybookHelpers-BGWobROM.js";import{n as g,t as de}from"./oscd-menu-item-GWUr0IbA.js";import{t as _}from"./oscd-filled-button-BmpnLsb3.js";import{t as fe}from"./oscd-list-item-CNrZlDQM.js";var v,pe=e((()=>{a(),m(),g(),v={"oscd-branded-fab":{argTypes:{label:{name:`Label Text`,control:{type:`text`},description:`Label text shown next to the FAB`},variant:{options:[`surface`,`primary`,`secondary`,`tertiary`],control:{type:`select`}},icon:{name:`Icon Name`,control:{type:`text`},description:`Material Icon name`}},args:{label:`Branded Fab Button`,icon:`edit`,variant:`primary`},meta:{render:({label:e,icon:t,...r})=>{let{template:i}=h(`oscd-branded-fab`);return n`
          <style>
            label {
              display: flex;
...
`})),A,me=e((()=>{se(),oe(),C(),T(),D(),k(),c(),A=class extends s(S){static{this.scopedElements={"md-ripple":ae,"md-focus-ring":ie}}static{this.styles=[O,E,w]}}})),j=e((()=>{me(),customElements.define(`oscd-assist-chip`,A)})),M,he=e((()=>{a(),m(),j(),M={"oscd-assist-chip":{args:{textContent:`Assist Chip`}},"oscd-chip-set":{meta:{render:e=>{let{template:t}=h(`oscd-chip-set`);return t(e,n` <oscd-chip-set aria-label="Assist chips">
