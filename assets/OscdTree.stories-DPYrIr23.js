import{i as C,x as r,a as M,E as f}from"./iframe-BFpCwY9R.js";import{g as w}from"./index-CeNjisW3.js";import{g as F}from"./getStorybookMeta-gDO-wW0N.js";import{n as l,S as K}from"./list-item-styles-Bfc4eJrR.js";import{c as W,a as H,b as X,r as q}from"./OscdListItem-B_3Vgj5Y.js";import{O as V}from"./OscdCheckbox-CUAXXZLT.js";import"./oscd-menu-item-COy5XFsF.js";import"./oscd-outlined-text-field-CondyySt.js";import"./preload-helper-PPVm8Dsz.js";import"./getStorybookHelpers-cc4YvQDR.js";import"./OscdList-XsnvtwlT.js";import"./OscdMenuItem-DnbnThgq.js";import"./query-assigned-nodes-Ud0G1qU0.js";import"./redispatch-event-D1qO1AWI.js";import"./validator-C3KVGDlf.js";import"./form-associated-qER_3PrR.js";import"./checkbox-validator-CQVrzvKL.js";import"./OscdOutlinedTextField-C_3bodT-.js";import"./shared-styles-DKww1ZEb.js";import"./style-map-BGd_K8UZ.js";import"./on-report-validity-DiIWBLfR.js";import"./OscdOutlinedField-BfnWYMBB.js";import"./shared-styles-Dp4Khk2d.js";var Y=Object.defineProperty,T=(d,e,t,s)=>{for(var n=void 0,i=d.length-1,a;i>=0;i--)(a=d[i])&&(n=a(e,t,n)||n);return n&&Y(e,t,n),n};const R=class R extends C{constructor(){super(...arguments),this.selected=!1,this.active=!1,this.disabled=!1}render(){return r`<div part="content" class="content">
  ...
  >
    <span slot="headline">${"label"in d?String(d.label):e}</span>
      ...
      ></oscd-checkbox
    ></span>`}renderToggle(e){const s=I(e.node)!=="leaf",n=this.expandedIds.includes(e.id);return r`<button
      part="toggle"
      class="toggle"
    ...
    >
      ${s?r`<oscd-icon
          ...
          >`:f}
    </button>`}renderRow(e){const t=this.renderContext(e),s=t.childrenState,n=t.selected,i=t.disabled,a=t.active;return r`<div
      id=${e.htmlId}
      part="row"
      class="row"
      role="treeitem"
    ...
    >
      ...
      >
    </div>`}updated(){const e=this.renderRoot.querySelector('.row[data-active="true"]');e&&this.matches(":focus-within")&&e.focus()}render(){const e=this.visibleRows();return r`<div part="tree" class="tree" role="tree">
  ...
  </oscd-tree-item>`,ne=({node:d,childrenState:e,selected:t,disabled:s})=>r`<oscd-tree-item ?selected=${t} ?disabled=${s}>
    <span slot="headline">${d.label}</span>
    <span slot="supporting-text">${d.kind} / ${e}</span>
  </oscd-tree-item>`,ie=(d,e)=>{const t=e.trim().toLowerCase();return t?[d.label,d.description,d.kind,d.id].filter(s=>!!s).some(s=>s.toLowerCase().includes(t)):!0},O=(d,e)=>{const t=e.trim();return t?d.map(s=>{const n=s.children?O(s.children,t):s.children;if(!ie(s,t)&&(!n||n.length===0))return;const a={...s};return s.children!==void 0&&(a.children=n),a}).filter(s=>!!s):d},S=d=>{w("selected-ids-changed")(d.detail.selectedIds)},u=d=>{w("expanded-ids-changed")(d.detail.expandedIds)},we={...te,title:"Tree / Tree",tags:["autodocs"]},$={argTypes:m,args:{...h,".data":g,".expandedIds":["ied:PUB_A","ap:PUB_A/AP1"],".renderItem":v},render:d=>r`<div style="max-width: 520px;">
      <oscd-tree
        .data=${d[".data"]}
      ...
      ></oscd-tree>
    </div>`},A={argTypes:m,args:{...h,".data":g,".expandedIds":["ied:PUB_A","ap:PUB_A/AP1","ld:PUB_A/AP1/LD_A"],".selectedIds":["ln:PUB_A|AP1|LD_A||TCTR|1"],".renderItem":v,selectionMode:"multiple"},render:d=>r`<div style="max-width: 520px;">
      <oscd-tree
        ...
        @expanded-ids-changed=${u}
      ></oscd-tree>
    </div>`},y={argTypes:m,args:{...h,".data":g,".expandedIds":["ied:PUB_A","ap:PUB_A/AP1","ld:PUB_A/AP1/LD_A"],".selectedIds":["ln:PUB_A|AP1|LD_A||TCTR|1"],".renderItem":v,selectionMode:"single"},render:d=>r`<div style="max-width: 520px;">
      <oscd-tree
        selectionMode=${d.selectionMode}
        .data=${d[".data"]}
        .expandedIds=${d[".expandedIds"]}
        ...
        @expanded-ids-changed=${u}
      ></oscd-tree>
    </div>`},_={argTypes:m,args:{...h,".data":g,".expandedIds":["ied:PUB_A","ap:PUB_A/AP1","ld:PUB_A/AP1/LD_A"],".selectedIds":["ln:PUB_A|AP1|LD_A||TCTR|1"],".renderItem":v,selectionMode:"multiple"},render:d=>r`<div style="max-width: 520px;">
      <oscd-tree
        selectionMode=${d.selectionMode}
        .data=${d[".data"]}
        .expandedIds=${d[".expandedIds"]}
        ...
        @expanded-ids-changed=${u}
      ></oscd-tree>
    </div>`},P={argTypes:m,args:{...h,".data":de,".expandedIds":["ied:PUB_A"],".renderItem":ne},render:d=>r`<div style="max-width: 520px;">
      <oscd-tree
        .data=${d[".data"]}
        .expandedIds=${d[".expandedIds"]}
        .renderItem=${d[".renderItem"]}
        ...
        @expanded-ids-changed=${u}
      ></oscd-tree>
    </div>`},D={argTypes:m,args:{...h,".data":g.map(({id:d,...e})=>e),".expandedIds":["0","0/0"],".renderItem":v},render:d=>r`<div style="max-width: 520px;">
      <oscd-tree
        .data=${d[".data"]}
        .expandedIds=${d[".expandedIds"]}
        .renderItem=${d[".renderItem"]}
        @expanded-ids-changed=${u}
      ></oscd-tree>
    </div>`},k={argTypes:m,args:{...h,expandedIds:["ied:PUB_A"],filter:"TCTR"},render:d=>{const[e,t]=ee(),s=String(d.filter??""),n=d.expandedIds,i=O(g,s);return r`<div
      style="display: flex; flex-direction: column; gap: 12px; width: min(520px, 100%);"
    >
      <oscd-outlined-text-field
        label="Filter tree"
        .value=${s}
        @input=${a=>{const p=a.target;w("filter input")(p.value),t({filter:p.value})}}
      ></oscd-outlined-text-field>
      <oscd-tree
        .data=${i}
        .expandedIds=${n}
        .renderItem=${v}
        @expanded-ids-changed=${a=>{u(a),t({expandedIds:a.detail.expandedIds})}}
      ></oscd-tree>
...
}`,...k.parameters?.docs?.source}}};const Be=["Default","MultipleSelection","SingleSelection","DisabledRows","UnknownChildren","DerivedIds","Filtered"];export{$ as Default,D as DerivedIds,_ as DisabledRows,k as Filtered,A as MultipleSelection,y as SingleSelection,P as UnknownChildren,Be as __namedExportsOrder,we as default};
