import{i as e}from"./preload-helper-xPQekRTU.js";import{T as t,b as n,f as r,h as i,u as a}from"./static-html-JNahc6jH.js";import{I as o,L as s,_ as c,j as l,k as u}from"./list-navigation-helpers-C1Ibc9kd.js";import{C as ee,n as te,t as ne,v as re,w as d,y as ie}from"./OscdIcon-CDSDekmX.js";import{n as f,t as p}from"./decorate-DTsqE9Ek.js";import{n as ae}from"./oscd-menu-item-GWUr0IbA.js";import{n as oe,t as m}from"./getStorybookMeta-Ddn_OaDx.js";import{n as se,t as ce}from"./OscdCheckbox-BZlszYRb.js";import{t as le}from"./oscd-outlined-text-field-eY1wMwtN.js";var h,ue=e((()=>{a(),c(),f(),h=class extends r{constructor(...e){super(...e),this.selected=!1,this.active=!1,this.disabled=!1,this.hasLeadingContent=!1}connectedCallback(){super.connectedCallback(),this.hasLeadingContent=this.querySelector(`[slot="start"]`)!==null}handleStartSlotChange(e){this.hasLeadingContent=e.target.assignedElements({flatten:!0}).length>0}render(){return n`<div part="content" class="content">
      <span
        part="leading"
  ...
  >
    ...
    >
      ...
      <span part="content" class="content"
        >${(this.renderItem??b)(t)}</span
      >
      ${this.togglePosition===`trailing`?this.renderToggle(e,t):i}
    </div>`}updated(){if(this.renderRoot instanceof ShadowRoot&&this.renderRoot.activeElement?.closest(`.accessory`))return;let e=this.renderRoot.querySelector(`.row[data-active="true"]`);e&&this.matches(`:focus-within`)&&e.focus()}render(){return n`<div part="tree" class="tree" role="tree">
  ...
  `}},p([l({attribute:!1})],S.prototype,`data`,void 0),p([l({attribute:!1})],S.prototype,`selectedIds`,void 0),p([l({attribute:!1})],S.prototype,`expandedIds`,void 0),p([l({attribute:!1})],S.prototype,`renderItem`,void 0),p([l({attribute:!1})],S.prototype,`renderLeafAccessory`,void 0),p([l({attribute:!1})],S.prototype,`getNodeId`,void 0),p([l({attribute:!1})],S.prototype,`getNodeLabel`,void 0),p([l({attribute:!1})],S.prototype,`isSelectable`,void 0),p([l({attribute:!1})],S.prototype,`isDisabled`,void 0),p([l()],S.prototype,`selectionMode`,void 0),p([l({attribute:`collapse-icon`})],S.prototype,`collapseIcon`,void 0),p([l({attribute:`expand-icon`})],S.prototype,`expandIcon`,void 0),p([l({reflect:!0,attribute:`toggle-position`})],S.prototype,`togglePosition`,void 0),p([u()],S.prototype,`activeId`,void 0)})),w,de=e((()=>{C(),w=class extends S{}})),fe=e((()=>{_(),customElements.define(`oscd-tree-item`,g)})),pe=e((()=>{de(),fe(),customElements.define(`oscd-tree`,w)})),T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{a(),oe(),pe(),ae(),le(),{action:T}=__STORYBOOK_MODULE_ACTIONS__,{useArgs:E}=__STORYBOOK_MODULE_PREVIEW_API__,{args:D,argTypes:O,meta:k}=m({tagName:`oscd-tree`}),A=[{id:`ied:PUB_A`,label:`PUB_A`,description:`Publisher IED`,kind:`ied`,children:[{id:`ap:PUB_A/AP1`,label:`AP1`,description:`Access point`,kind:`access-point`,children:[{id:`ld:PUB_A/AP1/LD_A`,label:`LD_A`,description:`Logical device`,kind:`l-device`,children:[{id:`ln:PUB_A|AP1|LD_A||LLN0|`,label:`LLN0`,description:`Logical node zero`,kind:`logical-node`,children:[]},{id:`ln:PUB_A|AP1|LD_A||TCTR|1`,label:`TCTR1`,description:`Current transformer`,kind:`logical-node`,children:[]},{id:`ln:PUB_A|AP1|LD_A||XCBR|1`,label:`XCBR1`,description:`Circuit breaker`,kind:`logical-node`,children:[]}]}]}]},{id:`ied:PUB_B`,label:`PUB_B`,description:`Publisher IED`,kind:`ied`,children:[{id:`ap:PUB_B/AP1`,label:`AP1`,description:`Access point`,kind:`access-point`,children:[{id:`ld:PUB_B/AP1/LD_B`,label:`LD_B`,description:`Logical device`,kind:`l-device`,children:[{id:`ln:PUB_B|AP1|LD_B||LLN0|`,label:`LLN0`,description:`Logical node zero`,kind:`logical-node`,children:[]},{id:`ln:PUB_B|AP1|LD_B||TCTR|1`,label:`TCTR1`,description:`Current transformer`,kind:`logical-node`,children:[]}]}]}]}],j=[...A,{id:`ied:REMOTE`,label:`REMOTE`,description:`Children are not loaded yet`,kind:`ied`}],M=e=>{switch(e){case`ied`:return`reportIcon`;case`access-point`:return`lan`;case`l-device`:return`dns`;case`logical-node`:return`article`;default:return`circle`}},N=({node:e,selected:t,active:r,disabled:i})=>n`<oscd-tree-item
    ?selected=${t}
    ?active=${r}
    ?disabled=${i}
  >
    <oscd-icon slot="start">${M(e.kind)}</oscd-icon>
    <span slot="headline">${e.label}</span>
    <span slot="supporting-text">${e.description}</span>
  </oscd-tree-item>`,P=({node:e,childrenState:t,selected:r,disabled:i})=>n`<oscd-tree-item ?selected=${r} ?disabled=${i}>
    <span slot="headline">${e.label}</span>
    <span slot="supporting-text">${e.kind} / ${t}</span>
  </oscd-tree-item>`,F=({node:e,selected:t,active:r,disabled:i})=>n`<oscd-tree-item
    ?selected=${t}
    ?active=${r}
    ?disabled=${i}
  >
    ${e.kind===`ied`?n`<oscd-icon slot="start">${M(e.kind)}</oscd-icon>`:``}
    <span slot="headline">${e.label}</span>
    <span slot="supporting-text">${e.description}</span>
  </oscd-tree-item>`,I=(e,t)=>{let n=t.trim().toLowerCase();return n?[e.label,e.description,e.kind,e.id].filter(e=>!!e).some(e=>e.toLowerCase().includes(n)):!0},L=(e,t)=>{let n=t.trim();return n?e.map(e=>{let t=e.children?L(e.children,n):e.children;if(!I(e,n)&&(!t||t.length===0))return;let r={...e};return e.children!==void 0&&(r.children=t),r}).filter(e=>!!e):e},R=e=>{T(`selected-ids-changed`)(e.detail.selectedIds)},z=n`<svg
...
>
  <path
    ...
    fill="currentColor"
  />
</svg>`,V=e=>{T(`expanded-ids-changed`)(e.detail.expandedIds)},H={...k,title:`Tree / Tree`,tags:[`autodocs`]},U={argTypes:O,args:{...D,".data":A,".expandedIds":[`ied:PUB_A`,`ap:PUB_A/AP1`],".renderItem":N},render:e=>n`<div style="max-width: 520px;">
      <oscd-tree
        .data=${e[`.data`]}
        .expandedIds=${e[`.expandedIds`]}
        .renderItem=${e[`.renderItem`]}
        @expanded-ids-changed=${V}
      ></oscd-tree>
    </div>`},W={argTypes:O,args:{...D,".data":A,".expandedIds":[`ied:PUB_A`,`ap:PUB_A/AP1`,`ld:PUB_A/AP1/LD_A`],".selectedIds":[`ln:PUB_A|AP1|LD_A||TCTR|1`],".renderItem":N,selectionMode:`multiple`},render:e=>n`<div style="max-width: 520px;">
      <oscd-tree
        ...
        @selected-ids-changed=${R}
        @expanded-ids-changed=${V}
      ></oscd-tree>
    </div>`},G={argTypes:O,args:{...D,".data":A,".expandedIds":[`ied:PUB_A`,`ap:PUB_A/AP1`,`ld:PUB_A/AP1/LD_A`],".selectedIds":[`ln:PUB_A|AP1|LD_A||TCTR|1`],".renderItem":N,selectionMode:`single`},render:e=>n`<div style="max-width: 520px;">
      <oscd-tree
        selectionMode=${e.selectionMode}
        .data=${e[`.data`]}
        .expandedIds=${e[`.expandedIds`]}
        ...
        @expanded-ids-changed=${V}
      ></oscd-tree>
    </div>`},K={argTypes:O,args:{...D,".data":A,".expandedIds":[`ied:PUB_A`,`ap:PUB_A/AP1`,`ld:PUB_A/AP1/LD_A`],".selectedIds":[`ln:PUB_A|AP1|LD_A||TCTR|1`],".renderItem":N,selectionMode:`multiple`},render:e=>n`<div style="max-width: 520px;">
      <oscd-tree
        selectionMode=${e.selectionMode}
        .data=${e[`.data`]}
        .expandedIds=${e[`.expandedIds`]}
        ...
        @expanded-ids-changed=${V}
      ></oscd-tree>
    </div>`},q={argTypes:O,args:{...D,".data":j,".expandedIds":[`ied:PUB_A`],".renderItem":P},render:e=>n`<div style="max-width: 520px;">
      <oscd-tree
        .data=${e[`.data`]}
        .expandedIds=${e[`.expandedIds`]}
        .renderItem=${e[`.renderItem`]}
        @node-expand=${e=>{let t=e;t.detail.id===`ied:REMOTE`&&(t.preventDefault(),T(`lazy node-expand prevented`)(t.detail.id))}}
        @expanded-ids-changed=${V}
      ></oscd-tree>
    </div>`},J={argTypes:O,args:{...D,".data":A.map(({id:e,...t})=>t),".expandedIds":[`0`,`0/0`],".renderItem":N},render:e=>n`<div style="max-width: 520px;">
      <oscd-tree
        .data=${e[`.data`]}
        .expandedIds=${e[`.expandedIds`]}
        .renderItem=${e[`.renderItem`]}
        @expanded-ids-changed=${V}
      ></oscd-tree>
    </div>`},Y={argTypes:{...O,togglePosition:{name:`toggle-position`,control:{type:`inline-radio`},options:[`leading`,`trailing`],description:`Placement of the expand/collapse toggle within each row.`},collapseIcon:{name:`collapse-icon`,control:{type:`text`},description:`Icon shown on the toggle when a branch is collapsed.`},expandIcon:{name:`expand-icon`,control:{type:`text`},description:`Icon shown on the toggle when a branch is expanded.`}},args:{...D,".data":A,".expandedIds":[`ied:PUB_A`,`ap:PUB_A/AP1`],".renderItem":N,togglePosition:`trailing`,collapseIcon:`chevron_right`,expandIcon:`expand_more`},render:e=>n`<div style="max-width: 520px;">
      <oscd-tree
        ...
        @expanded-ids-changed=${V}
      ></oscd-tree>
    </div>`},X={argTypes:O,args:{...D,".data":A,".expandedIds":[`ied:PUB_A`,`ap:PUB_A/AP1`,`ld:PUB_A/AP1/LD_A`],".renderItem":N,togglePosition:`trailing`,pinnedIds:[`ln:PUB_A|AP1|LD_A||TCTR|1`]},render:e=>{let[t,r]=E(),i=e.pinnedIds??[],a=e=>{let t=i.includes(e)?i.filter(t=>t!==e):[...i,e];T(`pinned-ids-changed`)(t),r({pinnedIds:t})};return n`<div style="max-width: 520px;">
      <oscd-tree
        toggle-position=${e.togglePosition}
        .data=${e[`.data`]}
        .expandedIds=${e[`.expandedIds`]}
        ...
        @expanded-ids-changed=${V}
      ></oscd-tree>
    </div>`}},Z={argTypes:{...O,indentStep:{name:`--oscd-tree-indent-step`,control:{type:`text`},description:`Drives both per-level indentation and the leading icon column width. Because a leading icon occupies exactly one indent step, icon-less children align their text under their iconed parent automatically. Set it large enough to hold the icon (e.g. 40px).`}},args:{...D,".data":A,".expandedIds":[`ied:PUB_A`,`ap:PUB_A/AP1`,`ld:PUB_A/AP1/LD_A`],".renderItem":F,togglePosition:`trailing`,indentStep:`40px`},render:e=>n`<div style="max-width: 520px;">
      <oscd-tree
        ...
        @expanded-ids-changed=${V}
      ></oscd-tree>
    </div>`},Q={argTypes:O,args:{...D,expandedIds:[`ied:PUB_A`],filter:`TCTR`},render:e=>{let[t,r]=E(),i=String(e.filter??``),a=e.expandedIds;return n`<div
      style="display: flex; flex-direction: column; gap: 12px; width: min(520px, 100%);"
    >
      <oscd-outlined-text-field
        label="Filter tree"
        .value=${i}
        @input=${e=>{let t=e.target;T(`filter input`)(t.value),r({filter:t.value})}}
      ></oscd-outlined-text-field>
      <oscd-tree
        .data=${L(A,i)}
        .expandedIds=${a}
        .renderItem=${N}
        @expanded-ids-changed=${e=>{V(e),r({expandedIds:e.detail.expandedIds})}}
      ></oscd-tree>
...
}`,...Q.parameters?.docs?.source}}},$=[`Default`,`MultipleSelection`,`SingleSelection`,`DisabledRows`,`UnknownChildren`,`DerivedIds`,`ToggleCustomization`,`PinnableLeaves`,`AlignedLeadingIcons`,`Filtered`]}))();export{Z as AlignedLeadingIcons,U as Default,J as DerivedIds,K as DisabledRows,Q as Filtered,W as MultipleSelection,X as PinnableLeaves,G as SingleSelection,Y as ToggleCustomization,q as UnknownChildren,$ as __namedExportsOrder,H as default};