import{O as l,S as r}from"./OscdSclIcon-B89bPdKw.js";import{g as a}from"./getStorybookMeta-5v34_TjP.js";import{x as c}from"./iframe-bV8sXuOy.js";import"./list-item-styles-oRaTTV7d.js";import"./OscdListItem-DFmTB3bM.js";import"./getStorybookHelpers-Dixdbl-W.js";import"./OscdMenuItem-DbC5QpUl.js";import"./query-assigned-nodes-BDCLEJeA.js";import"./preload-helper-PPVm8Dsz.js";customElements.define("oscd-scl-icon",l);const{args:i,argTypes:d,meta:p}=a({tagName:"oscd-scl-icon"}),f={...p,title:"Icons / SCL Icon",tags:["autodocs"]},e={argTypes:{textContent:{options:Object.keys(r),control:{type:"select"},description:"SCL Icon to be displayed."},...d},args:{...i,textContent:i.textContent??"elementIcon"},render:({textContent:n,...s})=>c`<div>
      <style>
        .standard {
          --md-icon-size: 24px;
        }
