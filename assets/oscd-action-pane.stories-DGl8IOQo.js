import{i as $,E as g,x as o,a as b}from"./iframe-D_AT4TIz.js";import{S as f,b as x,n as l}from"./list-item-styles-B8z8P4EW.js";import{a as w}from"./OscdListItem-Dtz4smBz.js";import{g as L}from"./getStorybookMeta-DSrCqPZ2.js";import"./preload-helper-PPVm8Dsz.js";import"./getStorybookHelpers-BPhoQ4a6.js";import"./oscd-menu-item-BRx5nmZc.js";import"./OscdMenuItem-BwTzKIea.js";import"./query-assigned-nodes-BPJpqv7A.js";import"./OscdList-Diogj996.js";var E=Object.defineProperty,s=(n,e,i,t)=>{for(var c=void 0,h=n.length-1,v;h>=0;h--)(v=n[h])&&(c=v(e,i,c)||c);return c&&E(e,i,c),c};function m(n,e){const i=n.nodeType===Node.ELEMENT_NODE?n.closest(e):null;if(i)return i;const t=n.getRootNode();return t instanceof ShadowRoot?m(t.host,e):null}const p=class p extends f($){constructor(){super(...arguments),this.secondary=!1,this.highlighted=!1,this.level=1}connectedCallback(){super.connectedCallback(),this.tabIndex=0,this.parentPane=m(this.parentNode,"oscd-action-pane")??void 0}get resolvedLevel(){const e=this.parentPane?this.parentPane.resolvedLevel+1:this.level;return Math.floor(e)}renderHeader(){const e=o`<span
        ><slot name="icon"
