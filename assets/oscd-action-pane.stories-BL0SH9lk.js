import{i as $,E as g,x as o,a as b}from"./iframe-BFpCwY9R.js";import{S as f,b as x,n as l}from"./list-item-styles-Bfc4eJrR.js";import{a as w}from"./OscdListItem-B_3Vgj5Y.js";import{g as L}from"./getStorybookMeta-gDO-wW0N.js";import"./preload-helper-PPVm8Dsz.js";import"./getStorybookHelpers-cc4YvQDR.js";import"./oscd-menu-item-COy5XFsF.js";import"./OscdMenuItem-DnbnThgq.js";import"./query-assigned-nodes-Ud0G1qU0.js";import"./OscdList-XsnvtwlT.js";var E=Object.defineProperty,s=(n,e,i,t)=>{for(var c=void 0,h=n.length-1,v;h>=0;h--)(v=n[h])&&(c=v(e,i,c)||c);return c&&E(e,i,c),c};function m(n,e){const i=n.nodeType===Node.ELEMENT_NODE?n.closest(e):null;if(i)return i;const t=n.getRootNode();return t instanceof ShadowRoot?m(t.host,e):null}const p=class p extends f($){constructor(){super(...arguments),this.secondary=!1,this.highlighted=!1,this.level=1}connectedCallback(){super.connectedCallback(),this.tabIndex=0,this.parentPane=m(this.parentNode,"oscd-action-pane")??void 0}get resolvedLevel(){const e=this.parentPane?this.parentPane.resolvedLevel+1:this.level;return Math.floor(e)}renderHeader(){const e=o`<span
        ><slot name="icon"
  ...
  `;let a=p;s([l({type:String})],a.prototype,"label");s([l({type:String})],a.prototype,"icon");s([l({type:Boolean})],a.prototype,"secondary");s([l({type:Boolean})],a.prototype,"highlighted");s([l({type:Number})],a.prototype,"level");window.customElements.define("oscd-action-pane",a);const{args:u,argTypes:y,meta:S}=L({tagName:"oscd-action-pane"}),H={title:"Action Controls/Action Pane",tags:["autodocs"],...S},d={argTypes:y,args:u,render:({label:n,icon:e})=>o`<div>
...
}`,...r.parameters?.docs?.source}}};const I=["CalculatedLevels","DefinedLevels"];export{d as CalculatedLevels,r as DefinedLevels,I as __namedExportsOrder,H as default};
