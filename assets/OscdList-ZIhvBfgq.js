import{_ as o}from"./list-navigation-helpers-CWtHtHq2.js";import{i as l,x as r,a}from"./iframe-CzfB892c.js";import{L as n,N as c,o as m}from"./OscdIcon-D6gSxZ3c.js";const d=new Set(Object.values(c));class i extends l{get items(){return this.listController.items}constructor(){super(),this.listController=new n({isItem:t=>t.hasAttribute("md-list-item"),getPossibleItems:()=>this.slotItems,isRtl:()=>getComputedStyle(this).direction==="rtl",deactivateItem:t=>{t.tabIndex=-1},activateItem:t=>{t.tabIndex=0},isNavigableKey:t=>d.has(t),isActivatable:t=>!t.disabled&&t.type!=="text"}),this.internals=this.attachInternals(),this.internals.role="list",this.addEventListener("keydown",this.listController.handleKeydown)}render(){return r`
      <slot
