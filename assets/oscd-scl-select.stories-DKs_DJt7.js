import{g as f}from"./getStorybookMeta-jb8d2n-5.js";import{i as S,x as o,a as v}from"./iframe-BxxurlDP.js";import{S as x,n as s,a as b}from"./list-item-styles-DDIVumax.js";import{r as m}from"./OscdListItem-CcTOxY3J.js";import{O as w}from"./OscdFilledSelect-BOlUAde-.js";import{O as V}from"./OscdSelectOption-CiGlWp0d.js";import{O as $}from"./OscdSwitch-CxRwutfG.js";import{o as N}from"./if-defined-BMOuWjOk.js";import"./oscd-select-option-DReFrOD9.js";import"./getStorybookHelpers-DKJ4wwK_.js";import"./OscdMenuItem-BgDjJhKl.js";import"./query-assigned-nodes-DB9p0wIF.js";import"./preload-helper-PPVm8Dsz.js";import"./shared-styles-CWK58rhf.js";import"./style-map-VJYNW7EI.js";import"./redispatch-event-D1qO1AWI.js";import"./validator-qBBhIEAC.js";import"./form-associated-DZlGCUjv.js";import"./on-report-validity-BZRFIofC.js";import"./menu-3dE_lCPE.js";import"./OscdFilledField-CmxSha1X.js";import"./shared-styles-DzwX3efC.js";import"./OscdMenu-72bnSI7C.js";import"./checkbox-validator-CqLsnnmV.js";var T=Object.defineProperty,C=Object.getOwnPropertyDescriptor,l=(O,e,c,i)=>{for(var r=i>1?void 0:i?C(e,c):e,d=O.length-1,h;d>=0;d--)(h=O[d])&&(r=(i?h(e,c,r):h(r))||r);return i&&r&&T(e,c,r),r};const u=class u extends x(S){constructor(){super(...arguments),this.nullable=!1,this.selectValue="",this.selectOptions=[],this.disabled=!1,this.label="",this.required=!1,this.supportingText="",this.error=!1,this.isNull=!1,this.parkedValue=null}set value(e){e===null?this.null=!0:(this.null=!1,this.selectValue=e)}get value(){return this.null?null:this.selectValue}get null(){return this.nullable&&this.isNull}set null(e){!this.nullable||e===this.isNull||(this.isNull=e,this.isNull?this.parkedValue=this.selectValue:(this.selectValue=this.parkedValue??"",this.parkedValue=null))}reportValidity(){return this.selectInput.reportValidity()}setCustomValidity(e){this.selectInput?.setCustomValidity(e)}checkValidity(){return this.selectInput.checkValidity()}renderNullSwitch(){return this.nullable?o`<oscd-switch
