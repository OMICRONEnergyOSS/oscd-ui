import{i as e}from"./preload-helper-xPQekRTU.js";import{b as t,u as n}from"./static-html-JNahc6jH.js";import{n as r,t as i}from"./getStorybookMeta-BOUCYHqO.js";import{i as a,n as o,r as s,t as c}from"./storybook-utils-BqChXPul.js";import{t as l}from"./oscd-elevated-card-Cu-jNr5-.js";var u=e((()=>{a(),window.customElements.define(`oscd-selection-list`,s)})),d,f,p,m,h,g,_,v,y,b,x;e((()=>{u(),l(),r(),n(),c(),{action:d}=__STORYBOOK_MODULE_ACTIONS__,{args:f,argTypes:p,meta:m,template:h}=i({tagName:`oscd-selection-list`}),g={title:`Lists/Selection List`,tags:[`autodocs`],...m,render:e=>t` <style>
        oscd-elevated-card {
