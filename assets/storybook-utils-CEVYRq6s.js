import{x as r,a as m}from"./iframe-C4uLaTi3.js";import{b as h,n}from"./list-navigation-helpers-uOLGipP7.js";import{O as u}from"./OscdCheckbox-BByuhJVy.js";import{O as f}from"./OscdRadio-rZjVmI0d.js";import{O as g}from"./OscdIcon-C3sU6W8j.js";import{O as y}from"./OscdList-C90geFFa.js";import{O as x}from"./OscdListItem-CcUpt_sr.js";import{O as C}from"./OscdOutlinedTextField-Dd6Lhoh6.js";import{F as b}from"./FilterListBase-CpNEnwHu.js";var E=Object.defineProperty,v=Object.getOwnPropertyDescriptor,p=(t,e,s,c)=>{for(var o=c>1?void 0:c?v(e,s):e,i=t.length-1,l;i>=0;i--)(l=t[i])&&(o=(c?l(e,s,o):l(o))||o);return c&&o&&E(e,s,o),o};function O(t){return r`<oscd-checkbox
    slot="start"
    ?checked=${t.selected}
    ?disabled=${t.disabled}
  ></oscd-checkbox>`}function $(t,e){return r`<oscd-radio
    slot="start"
    name=${e}
    ?checked=${t.selected}
    ?disabled=${t.disabled}
  ></oscd-radio>`}const a=class a extends b{constructor(){super(...arguments),this.multiselect=!1,this.items=[]}get selectedElements(){const e=[];return this.items.forEach(s=>{s.selected&&s.attachedElement&&e.push(s.attachedElement)}),e}renderListItem(e){return r`<oscd-list-item
    ...
    >
      ${this.multiselect?O(e):$(e,"radio-group")}
      ...
      >
    </section>`}};a.scopedElements={"oscd-outlined-text-field":C,"oscd-icon":g,"oscd-list":y,"oscd-list-item":x,"oscd-checkbox":u,"oscd-radio":f},a.styles=m`
    section {
      display: flex;
  ...
  `;let d=a;p([n({type:Boolean})],d.prototype,"multiselect",2);p([n({type:Array})],d.prototype,"items",2);p([n({type:Array})],d.prototype,"selectedElements",1);function S(t,e){return new CustomEvent("selection-list-change",{bubbles:!0,composed:!0,...e,detail:{selectedElements:t,...e?.detail}})}const B=new DOMParser().parseFromString(`<SCL>
...
</SCL>`,"application/xml");export{d as O,B as s};
