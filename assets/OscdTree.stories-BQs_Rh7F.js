import{i as N,x as r,a as j,E as u}from"./iframe-CzfB892c.js";import{g as f}from"./index-CeNjisW3.js";import{g as X}from"./getStorybookMeta-DOS5upft.js";import{n as l,S as V}from"./list-navigation-helpers-CWtHtHq2.js";import{r as F,c as Y,O as G,a as J}from"./OscdIcon-D6gSxZ3c.js";import{O as Q}from"./OscdCheckbox-C7o6VquQ.js";import"./oscd-menu-item-Bv29e9fa.js";import"./oscd-outlined-text-field-BwuZcBdP.js";import"./preload-helper-PPVm8Dsz.js";import"./getStorybookHelpers-Bv3ZIOVO.js";import"./oscd-filled-button-DQw484Ye.js";import"./menuItemController-B_J_C6eD.js";import"./OscdList-ZIhvBfgq.js";import"./oscd-list-item-C0ScTv6k.js";import"./OscdListItem-aUMQlSYk.js";import"./list-item-styles-Bz0C6iu4.js";import"./redispatch-event-D1qO1AWI.js";import"./validator-DNzAhO9h.js";import"./form-associated-BTVmRIpu.js";import"./checkbox-validator-Dh2QDM13.js";import"./OscdMenuItem-DA-1vXHl.js";import"./query-assigned-nodes-CLgeST5H.js";import"./OscdOutlinedTextField-Bp_Aja_q.js";import"./shared-styles-D7RceSw8.js";import"./style-map-e5XHfPGA.js";import"./on-report-validity-Bx-7rykv.js";import"./OscdOutlinedField-B87lCXYz.js";import"./shared-styles-Csz4B7L3.js";var ee=Object.defineProperty,z=(n,e,t,d)=>{for(var s=void 0,i=n.length-1,a;i>=0;i--)(a=n[i])&&(s=a(e,t,s)||s);return s&&ee(e,t,s),s};const R=class R extends N{constructor(){super(...arguments),this.selected=!1,this.active=!1,this.disabled=!1,this.hasLeadingContent=!1}handleStartSlotChange(e){this.hasLeadingContent=e.target.assignedElements({flatten:!0}).length>0}render(){return r`<div part="content" class="content">
      <span
        part="leading"
  ...
  >
    ...
    </div>`}};S.scopedElements={"oscd-checkbox":Q,"oscd-focus-ring":J,"oscd-icon":G,"oscd-ripple":Y,"oscd-tree-item":K},S.styles=j`
    :host {
      display: block;
...
>
  <path
    ...
    fill="currentColor"
  />
</svg>`,x=n=>{f("expanded-ids-changed")(n.detail.expandedIds)},Ne={...ie,title:"Tree / Tree",tags:["autodocs"]},y={argTypes:h,args:{...g,".data":m,".expandedIds":["ied:PUB_A","ap:PUB_A/AP1"],".renderItem":I},render:n=>r`<div style="max-width: 520px;">
      <oscd-tree
        .data=${n[".data"]}
      ...
      ></oscd-tree>
    </div>`},A={argTypes:h,args:{...g,".data":m,".expandedIds":["ied:PUB_A","ap:PUB_A/AP1","ld:PUB_A/AP1/LD_A"],".selectedIds":["ln:PUB_A|AP1|LD_A||TCTR|1"],".renderItem":I,selectionMode:"multiple"},render:n=>r`<div style="max-width: 520px;">
      <oscd-tree
        ...
        @expanded-ids-changed=${x}
      ></oscd-tree>
    </div>`},P={argTypes:h,args:{...g,".data":m,".expandedIds":["ied:PUB_A","ap:PUB_A/AP1","ld:PUB_A/AP1/LD_A"],".selectedIds":["ln:PUB_A|AP1|LD_A||TCTR|1"],".renderItem":I,selectionMode:"single"},render:n=>r`<div style="max-width: 520px;">
      <oscd-tree
        selectionMode=${n.selectionMode}
        .data=${n[".data"]}
        .expandedIds=${n[".expandedIds"]}
        ...
        @expanded-ids-changed=${x}
      ></oscd-tree>
    </div>`},_={argTypes:h,args:{...g,".data":m,".expandedIds":["ied:PUB_A","ap:PUB_A/AP1","ld:PUB_A/AP1/LD_A"],".selectedIds":["ln:PUB_A|AP1|LD_A||TCTR|1"],".renderItem":I,selectionMode:"multiple"},render:n=>r`<div style="max-width: 520px;">
      <oscd-tree
        selectionMode=${n.selectionMode}
        .data=${n[".data"]}
        .expandedIds=${n[".expandedIds"]}
        ...
        @expanded-ids-changed=${x}
      ></oscd-tree>
    </div>`},w={argTypes:h,args:{...g,".data":ae,".expandedIds":["ied:PUB_A"],".renderItem":re},render:n=>r`<div style="max-width: 520px;">
      <oscd-tree
        .data=${n[".data"]}
        .expandedIds=${n[".expandedIds"]}
        .renderItem=${n[".renderItem"]}
        ...
        @expanded-ids-changed=${x}
      ></oscd-tree>
    </div>`},L={argTypes:h,args:{...g,".data":m.map(({id:n,...e})=>e),".expandedIds":["0","0/0"],".renderItem":I},render:n=>r`<div style="max-width: 520px;">
      <oscd-tree
        .data=${n[".data"]}
        .expandedIds=${n[".expandedIds"]}
        .renderItem=${n[".renderItem"]}
        @expanded-ids-changed=${x}
      ></oscd-tree>
    </div>`},B={argTypes:{...h,togglePosition:{name:"toggle-position",control:{type:"inline-radio"},options:["leading","trailing"],description:"Placement of the expand/collapse toggle within each row."},collapseIcon:{name:"collapse-icon",control:{type:"text"},description:"Icon shown on the toggle when a branch is collapsed."},expandIcon:{name:"expand-icon",control:{type:"text"},description:"Icon shown on the toggle when a branch is expanded."}},args:{...g,".data":m,".expandedIds":["ied:PUB_A","ap:PUB_A/AP1"],".renderItem":I,togglePosition:"trailing",collapseIcon:"chevron_right",expandIcon:"expand_more"},render:n=>r`<div style="max-width: 520px;">
      <oscd-tree
        ...
        @expanded-ids-changed=${x}
      ></oscd-tree>
    </div>`},T={argTypes:h,args:{...g,".data":m,".expandedIds":["ied:PUB_A","ap:PUB_A/AP1","ld:PUB_A/AP1/LD_A"],".renderItem":I,togglePosition:"trailing",pinnedIds:["ln:PUB_A|AP1|LD_A||TCTR|1"]},render:n=>{const[e,t]=W(),d=n.pinnedIds??[],s=i=>{const a=d.includes(i)?d.filter(c=>c!==i):[...d,i];f("pinned-ids-changed")(a),t({pinnedIds:a})};return r`<div style="max-width: 520px;">
      <oscd-tree
        toggle-position=${n.togglePosition}
        .data=${n[".data"]}
        .expandedIds=${n[".expandedIds"]}
        ...
        @expanded-ids-changed=${x}
      ></oscd-tree>
    </div>`}},k={argTypes:{...h,indentStep:{name:"--oscd-tree-indent-step",control:{type:"text"},description:"Drives both per-level indentation and the leading icon column width. Because a leading icon occupies exactly one indent step, icon-less children align their text under their iconed parent automatically. Set it large enough to hold the icon (e.g. 40px)."}},args:{...g,".data":m,".expandedIds":["ied:PUB_A","ap:PUB_A/AP1","ld:PUB_A/AP1/LD_A"],".renderItem":oe,togglePosition:"trailing",indentStep:"40px"},render:n=>r`<div style="max-width: 520px;">
      <oscd-tree
        ...
        @expanded-ids-changed=${x}
      ></oscd-tree>
    </div>`},D={argTypes:h,args:{...g,expandedIds:["ied:PUB_A"],filter:"TCTR"},render:n=>{const[e,t]=W(),d=String(n.filter??""),s=n.expandedIds,i=q(m,d);return r`<div
...
}`,...D.parameters?.docs?.source}}};const je=["Default","MultipleSelection","SingleSelection","DisabledRows","UnknownChildren","DerivedIds","ToggleCustomization","PinnableLeaves","AlignedLeadingIcons","Filtered"];export{k as AlignedLeadingIcons,y as Default,L as DerivedIds,_ as DisabledRows,D as Filtered,A as MultipleSelection,T as PinnableLeaves,P as SingleSelection,B as ToggleCustomization,w as UnknownChildren,je as __namedExportsOrder,Ne as default};
