import{i as e}from"./preload-helper-xPQekRTU.js";import{T as t,b as n,f as r,h as i,u as a}from"./static-html-JNahc6jH.js";import{F as o,I as s,L as c,M as l,N as u,P as d,_ as f,f as ee,h as te,j as p,m as ne,p as re}from"./list-navigation-helpers-C1Ibc9kd.js";import{A as ie,E as ae,T as oe,j as se}from"./OscdIcon-BLAkUGod.js";import{n as ce,t as le}from"./OscdList-D9R0bwqM.js";import{n as m,r as ue,t as h}from"./getStorybookHelpers-CE7wY263.js";import{n as g,t as de}from"./oscd-menu-item-CTcQZDW2.js";import{t as _}from"./oscd-filled-button-DrRjABpc.js";import{t as fe}from"./oscd-list-item-CH855jem.js";var v,pe=e((()=>{a(),m(),g(),v={"oscd-branded-fab":{argTypes:{label:{name:`Label Text`,control:{type:`text`},description:`Label text shown next to the FAB`},variant:{options:[`surface`,`primary`,`secondary`,`tertiary`],control:{type:`select`}},icon:{name:`Icon Name`,control:{type:`text`},description:`Material Icon name`}},args:{label:`Branded Fab Button`,icon:`edit`,variant:`primary`},meta:{render:({label:e,icon:t,...r})=>{let{template:i}=h(`oscd-branded-fab`);return n`
          <style>
            label {
              display: flex;
        ...
        `}}}}})),y,b,x=e((()=>{u(),a(),f(),ne(),ee(),y=re(r),b=class extends y{get rippleDisabled(){return this.disabled||this.softDisabled}constructor(){super(),this.disabled=!1,this.softDisabled=!1,this.alwaysFocusable=!1,this.label=``,this.hasIcon=!1,this.addEventListener(`click`,this.handleClick.bind(this))}focus(e){this.disabled&&!this.alwaysFocusable||super.focus(e)}render(){return n`
    ...
    `}handleIconChange(e){let t=e.target;this.hasIcon=t.assignedElements({flatten:!0}).length>0}handleClick(e){if(this.softDisabled||this.disabled&&this.alwaysFocusable){e.stopImmediatePropagation(),e.preventDefault();return}}},b.shadowRootOptions={...r.shadowRootOptions,delegatesFocus:!0},l([p({type:Boolean,reflect:!0})],b.prototype,`disabled`,void 0),l([p({type:Boolean,attribute:`soft-disabled`,reflect:!0})],b.prototype,`softDisabled`,void 0),l([p({type:Boolean,attribute:`always-focusable`})],b.prototype,`alwaysFocusable`,void 0),l([p()],b.prototype,`label`,void 0),l([p({type:Boolean,reflect:!0,attribute:`has-icon`})],b.prototype,`hasIcon`,void 0)})),S,C=e((()=>{u(),a(),f(),x(),S=class extends b{constructor(){super(...arguments),this.elevated=!1,this.href=``,this.download=``,this.target=``}get primaryId(){return this.href?`link`:`button`}get rippleDisabled(){return!this.href&&(this.disabled||this.softDisabled)}getContainerClasses(){return{...super.getContainerClasses(),disabled:!this.href&&(this.disabled||this.softDisabled),elevated:this.elevated,link:!!this.href}}renderPrimaryAction(e){let{ariaLabel:t}=this;return this.href?n`
        <a
...
`})),A,me=e((()=>{ae(),se(),C(),T(),D(),k(),c(),A=class extends s(S){static{this.scopedElements={"md-ripple":oe,"md-focus-ring":ie}}static{this.styles=[O,E,w]}}})),j=e((()=>{me(),customElements.define(`oscd-assist-chip`,A)})),M,he=e((()=>{a(),m(),j(),M={"oscd-assist-chip":{args:{textContent:`Assist Chip`}},"oscd-chip-set":{meta:{render:e=>{let{template:t}=h(`oscd-chip-set`);return t(e,n` <oscd-chip-set aria-label="Assist chips">
            <oscd-assist-chip> 'Assist chip' </oscd-assist-chip>
            <oscd-assist-chip> 'Assist chip' </oscd-assist-chip>
            <oscd-assist-chip> 'Assist chip' </oscd-assist-chip>
          </oscd-chip-set>`)}}},"oscd-filter-chip":{args:{textContent:`Filter Chip`,selected:!0}},"oscd-input-chip":{args:{textContent:`Input Chip`,selected:!0}},"oscd-suggestion-chip":{args:{textContent:`Suggestion Chip`,selected:!0}}}})),N,ge=e((()=>{N={"oscd-elevated-button":{args:{textContent:`Click Me`}},"oscd-filled-button":{args:{textContent:`Click Me`}},"oscd-filled-tonal-button":{args:{textContent:`Click Me`}},"oscd-outlined-button":{args:{textContent:`Click Me`}},"oscd-text-button":{args:{textContent:`Click Me`}}}})),P,F=e((()=>{a(),m(),P={"oscd-checkbox":{args:{label:`Checkbox Label`,"aria-label":`I am a checkbox`},argTypes:{label:{name:`Label Text`,control:{type:`text`},description:`Checkbox label text`}},meta:{render:e=>{let{template:t}=h(`oscd-checkbox`);return n`<label>
        ...
        </div>`}}}}})),L=e((()=>{ce(),customElements.define(`oscd-list`,le)})),R,ve=e((()=>{a(),m(),_(),L(),fe(),R={"oscd-elevation":{argTypes:{level:{name:`Elevation Level`,control:{type:`number`,min:0,max:5,step:1},description:`Elevation level (0-5)`}},args:{level:4},meta:{render:({level:e,...t})=>{let{template:r}=h(`oscd-elevation`);return n`
          <style>
            * {
        ...
        `}}}}var Y,Ce=e((()=>{a(),m(),g(),Y={"oscd-elevated-card":J(`oscd-elevated-card`,`Elevated Card`),"oscd-filled-card":J(`oscd-filled-card`,`Filled Card`),"oscd-outlined-card":J(`oscd-outlined-card`,`Outlined Card`)}})),X=e((()=>{o(),customElements.define(`oscd-elevation`,d)})),Z,we=e((()=>{a(),m(),X(),Z={"oscd-list":{meta:{render:e=>{let{template:t}=h(`oscd-list`);return n`
          <style>
            oscd-list {
              --md-elevation-level: 3;
            }
        ...
        `}}}}})),$,Ee=e((()=>{pe(),he(),ge(),F(),_e(),ve(),ye(),be(),xe(),Se(),Ce(),we(),Te(),$={...N,...P,...M,...V,...I,...R,...v,...W,...G,...q,...Y,...Z,...Q}}));function De({tagName:e,defaultArgs:t={},options:r={}}){let{template:i,events:a,...o}=h(e),s=$[e]||{},c={...o.argTypes,...s?.argTypes??{}};return{args:{...o.args,...t,...s?.args??{}},argTypes:c,meta:{component:e,tags:[`autodocs`],decorators:[ue],parameters:{layout:`centered`},argTypes:{...r.omitTextContent?{}:{textContent:{name:`Text Content`,control:{type:`text`},description:`Text content of Component`}},...c},render:e=>i(e,e.textContent?n` ${e.textContent} `:void 0),...s?.meta??{}},template:i}}var Oe=e((()=>{a(),m(),Ee()}));export{j as a,D as c,C as d,b as f,L as i,E as l,Oe as n,k as o,x as p,X as r,O as s,De as t,S as u};