import{i as e}from"./preload-helper-xPQekRTU.js";import{T as t,a as n,b as r,f as i,h as a,m as ee,t as o,u as s}from"./static-html-JNahc6jH.js";import{E as c,M as l,N as u,_ as d,c as f,d as p,f as m,h,j as g,k as _,m as v,p as y,x as b}from"./list-navigation-helpers-C1Ibc9kd.js";import{_ as x,h as S}from"./OscdIcon-CDSDekmX.js";import{f as C,h as w,m as T,o as E}from"./menuItemController-CnzJ7A_q.js";import{n as D,t as O}from"./redispatch-event-5TInYFn2.js";import{r as k,t as A}from"./style-map-DuRQUK6e.js";import{a as j,i as M,n as N,o as te,r as P,t as F}from"./validator-COEMgVs_.js";import{i as I,n as L,r as R}from"./form-associated-DQ9AOt6o.js";import{n as z,r as B,t as V}from"./on-report-validity-ByVxZska.js";import{o as H,r as U,s as W}from"./OscdMenu-BAWotDWy.js";var G,K=e((()=>{s(),N(),G=class extends F{computeValidity(e){return this.selectControl||=document.createElement(`select`),ee(r`<option value=${e.value}></option>`,this.selectControl),this.selectControl.value=e.value,this.selectControl.required=e.required,{validity:this.selectControl.validity,validationMessage:this.selectControl.validationMessage}}equals(e,t){return e.value===t.value&&e.required===t.required}copy({value:e,required:t}){return{value:e,required:t}}}}));function q(e){let t=[];for(let n=0;n<e.length;n++){let r=e[n];r.selected&&t.push([r,n])}return t}var J=e((()=>{})),Y,X,Z,Q,ne=e((()=>{u(),s(),d(),v(),A(),o(),m(),O(),j(),S(),R(),V(),K(),p(),C(),W(),U(),J(),X=Symbol(`value`),Z=y(z(te(I(x(i))))),Q=class extends Z{get value(){return this[X]}set value(e){this.lastUserSetValue=e,this.select(e)}get options(){return this.menu?.items??[]}get selectedIndex(){let[e,t]=(this.getSelectedOptions()??[])[0]??[];return t??-1}set selectedIndex(e){this.lastUserSetSelectedIndex=e,this.selectIndex(e)}get selectedOptions(){return(this.getSelectedOptions()??[]).map(([e])=>e)}get hasError(){return this.error||this.nativeError}constructor(){super(),this.quick=!1,this.required=!1,this.errorText=``,this.label=``,this.noAsterisk=!1,this.supportingText=``,this.error=!1,this.menuPositioning=`popover`,this.clampMenuWidth=!1,this.typeaheadDelay=200,this.hasLeadingIcon=!1,this.displayText=``,this.menuAlign=`start`,this[Y]=``,this.lastUserSetValue=null,this.lastUserSetSelectedIndex=null,this.lastSelectedOption=null,this.lastSelectedOptionRecords=[],this.nativeError=!1,this.nativeErrorText=``,this.focused=!1,this.open=!1,this.defaultFocus=E.NONE,this.prevOpen=this.open,this.selectWidth=0,this.addEventListener(`focus`,this.handleFocus.bind(this)),this.addEventListener(`blur`,this.handleBlur.bind(this))}select(e){let t=this.options.find(t=>t.value===e);t&&this.selectItem(t)}selectIndex(e){let t=this.options[e];t&&this.selectItem(t)}reset(){for(let e of this.options)e.selected=e.hasAttribute(`selected`);this.updateValueAndDisplayText(),this.nativeError=!1,this.nativeErrorText=``}showPicker(){this.open=!0}[(Y=X,B)](e){e?.preventDefault();let t=this.getErrorText();this.nativeError=!!e,this.nativeErrorText=this.validationMessage,t===this.getErrorText()&&this.field?.reannounceError()}update(e){if(this.hasUpdated||this.initUserSelection(),this.prevOpen!==this.open&&this.open){let e=this.getBoundingClientRect();this.selectWidth=e.width}this.prevOpen=this.open,super.update(e)}render(){return r`
      <span
    ...
    `}renderLabel(){return r`<div id="label">${this.displayText||r`&nbsp;`}</div>`}renderMenu(){let e=this.label||this.ariaLabel;return r`<div class="menu-wrapper">
      <md-menu
        ...
        anchor="field"
        style=${k({"--__menu-min-width":`${this.selectWidth}px`,"--__menu-max-width":this.clampMenuWidth?`${this.selectWidth}px`:void 0})}
        no-navigation-wrap
        .open=${this.open}
        .quick=${this.quick}
