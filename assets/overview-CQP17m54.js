import{j as e,f as s,h as i}from"./blocks-BhjhE5tY.js";import{useMDXComponents as r}from"./index-B1owD1Qa.js";import"./preload-helper-PPVm8Dsz.js";import"./iframe-BxxurlDP.js";const a=`[![Tests](https://github.com/OMICRONEnergyOSS/oscd-ui/actions/workflows/test.yml/badge.svg)](https://github.com/OMICRONEnergyOSS/oscd-ui/actions/workflows/test.yml) ![NPM Version](https://img.shields.io/npm/v/@omicronenergy/oscd-ui)
...
`;function t(n){return e.jsxs(e.Fragment,{children:[e.jsx(s,{title:"Open SCD/Overview"}),`
`,e.jsx(i,{children:a})]})}function d(n={}){const{wrapper:o}={...r(),...n.components};return o?e.jsx(o,{...n,children:e.jsx(t,{...n})}):t()}export{d as default};
