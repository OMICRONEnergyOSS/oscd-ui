import{f as l,S as r}from"./OscdListItem-C6Fu-I6V.js";import{g as a}from"./getStorybookMeta-CBumkAFM.js";import{x as c}from"./iframe-CprjnxQ1.js";import"./list-item-styles-CjF7S3P4.js";import"./getStorybookHelpers-Dzl6jIXq.js";import"./OscdMenuItem-7J0ZBKMK.js";import"./query-assigned-nodes-WkFDPTIo.js";import"./preload-helper-PPVm8Dsz.js";customElements.define("oscd-scl-icon",l);const{args:i,argTypes:d,meta:p}=a({tagName:"oscd-scl-icon"}),v={...p,title:"Icons / SCL Icon",tags:["autodocs"]},e={argTypes:{textContent:{options:Object.keys(r),control:{type:"select"},description:"SCL Icon to be displayed."},...d},args:{...i,textContent:i.textContent??"elementIcon"},render:({textContent:n,...s})=>c`<div>
      <style>
        .standard {
          --md-icon-size: 24px;
        }
