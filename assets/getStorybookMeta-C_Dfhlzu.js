import{x as a,i as C,E as r,a as y}from"./iframe-BlmIIjc8.js";import{g as s,s as O}from"./getStorybookHelpers-DQ9KU-nQ.js";import"./oscd-menu-item-vFGSEMX-.js";import{a as I,c as T}from"./OscdIcon-BF9UpfCs.js";import{m as k,_ as n,n as l,b as E,S as M,O as D}from"./list-navigation-helpers-BYaPgfdc.js";import"./oscd-filled-button-pAHRa5nn.js";import{O as A}from"./OscdList-a84XNi5w.js";import"./oscd-list-item-BA8wSq9a.js";const F={"oscd-branded-fab":{argTypes:{label:{name:"Label Text",control:{type:"text"},description:"Label text shown next to the FAB"},variant:{options:["surface","primary","secondary","tertiary"],control:{type:"select"}},icon:{name:"Icon Name",control:{type:"text"},description:"Material Icon name"}},args:{label:"Branded Fab Button",icon:"edit",variant:"primary"},meta:{render:({label:e,icon:t,...o})=>{const{template:i}=s("oscd-branded-fab");return a`
          <style>
            label {
              display: flex;
