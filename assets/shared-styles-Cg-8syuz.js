import{i as e}from"./preload-helper-xPQekRTU.js";import{T as t,a as n,b as r,f as i,h as a,n as o,t as s,u as c}from"./static-html-JNahc6jH.js";import{M as l,N as u,_ as d,f,h as p,j as m,k as h,m as g,p as _}from"./list-navigation-helpers-C1Ibc9kd.js";import{S as v,_ as y,b,g as x,h as S,m as C,p as w,w as T,x as E}from"./OscdIcon-BLAkUGod.js";import{n as D,t as O}from"./is-rtl-loYdLwK7.js";var k,A,j=e((()=>{u(),c(),d(),g(),s(),f(),O(),x(),v(),b(),w(),k=_(C(E(T(i)))),A=class extends k{constructor(){super(),this.softDisabled=!1,this.flipIconInRtl=!1,this.href=``,this.download=``,this.target=``,this.ariaLabelSelected=``,this.toggle=!1,this.selected=!1,this.flipIcon=D(this,this.flipIconInRtl),y(this,`click`),this.addEventListener(`click`,e=>{if(this.softDisabled||this.disabled&&this.href){e.stopImmediatePropagation(),e.preventDefault();return}let t=this.selected;S(e,()=>{!this.toggle||this.disabled||e.defaultPrevented||(this.selected=!t,this.dispatchEvent(new InputEvent(`input`,{bubbles:!0,composed:!0})),this.dispatchEvent(new Event(`change`,{bubbles:!0})))})})}willUpdate(){this.href&&(this.disabled=!1,this.softDisabled=!1)}render(){let e=this.href?o`div`:o`button`,{ariaLabel:t,ariaHasPopup:r,ariaExpanded:i}=this,s=t&&this.ariaLabelSelected,c=this.toggle?this.selected:a,l=a;return this.href||(l=s&&this.selected?this.ariaLabelSelected:t),n`<${e}
