import{i as y,x as r,a as b}from"./iframe-C4uLaTi3.js";import{S as k,n as L}from"./list-navigation-helpers-uOLGipP7.js";import{r as v}from"./OscdIcon-C3sU6W8j.js";import{O as S}from"./OscdIconButton-5cjKo4Uu.js";import{g as $}from"./getStorybookMeta-fEcaYkww.js";import"./preload-helper-PPVm8Dsz.js";import"./shared-styles-PERDfklm.js";import"./is-rtl-DJNyvqXe.js";import"./getStorybookHelpers-BPPERp-C.js";import"./oscd-menu-item-D6eVNoir.js";import"./OscdListItem-CcUpt_sr.js";import"./list-item-styles-CwxrGOCZ.js";import"./OscdMenuItem-AVFwwFRE.js";import"./query-assigned-nodes-EHSBqaR2.js";import"./menuItemController-vk-DquCy.js";import"./oscd-filled-button-CEBWtmCm.js";import"./OscdList-C90geFFa.js";var E=Object.defineProperty,w=(p,e,t,o)=>{for(var i=void 0,a=p.length-1,n;a>=0;a--)(n=p[a])&&(i=n(e,t,i)||i);return i&&E(e,t,i),i};function A(p){let e=0;const t=o=>{o&&(o.leaf&&o.leaf.length&&(e=Math.max(e,o.leaf.length)),o.children?.forEach(t))};return t(p),e}const u=class u extends k(y){constructor(){super(...arguments),this.data=null,this.folded=new Set,this.knownPaths=new Set,this.maxLeafCols=0}pathKey(e){return e.join(".")||"root"}willUpdate(e){if(this.data){const t=new Set,o=(n,c=[])=>{if(n){if(c.length>0&&n.children!==void 0){const h=this.pathKey(c);t.add(h)}n.children?.forEach((h,f)=>o(h,[...c,"children",f]))}};o(this.data,[]);const i=new Set(this.folded);t.forEach(n=>{this.knownPaths.has(n)||i.add(n)});const a=new Set;i.forEach(n=>{t.has(n)&&a.add(n)}),this.folded=a,this.knownPaths=t,this.maxLeafCols=A(this.data)}}toggleFold(e,t){const o=this.pathKey(e),i=new Set(this.folded),a=i.has(o);i.has(o)?i.delete(o):i.add(o),this.folded=i,this.requestUpdate(),a&&t&&t.leaf===void 0&&Array.isArray(t.children)&&t.children.length===0&&this.dispatchEvent(new CustomEvent("unfold",{detail:t,bubbles:!0,composed:!0}))}renderLeadingIcon(e){return e.icon instanceof SVGElement?r`<span class="leading-icon">${e.icon}</span>`:typeof e.icon=="string"?r`<span class="leading-icon ms">${e.icon}</span>`:r``}renderRows(e,t=[],o=0,i=!1){if(!e)return[];const a=[],n=e.children!==void 0,c=!!(e.children&&e.children.length>0),h=this.pathKey(t),f=this.folded.has(h),x=e.leaf??[];return a.push(r`
      <tr class="tree-row ${i?"child-hidden":""}">
        ...
        ${Array.from({length:this.maxLeafCols},(s,m)=>{const d=x[m];return r`<td class="val-cell">
            ${d?r`
                  <div class="val-inner">
                    ${d.edit?r`
                          <icon-button
                            aria-label="Edit value ${m+1}"
                            @click=${d.edit}
                          >
    ...
    `),c&&e.children.forEach((s,m)=>{const d=this.renderRows(s,[...t,"children",m],o+1,i||f);a.push(...d)}),a}render(){return this.data?r`
