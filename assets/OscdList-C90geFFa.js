import{_ as o}from"./list-navigation-helpers-uOLGipP7.js";import{i as l,x as r,a}from"./iframe-C4uLaTi3.js";import{L as n,N as c,o as m}from"./OscdIcon-C3sU6W8j.js";const d=new Set(Object.values(c));class i extends l{get items(){return this.listController.items}constructor(){super(),this.listController=new n({isItem:t=>t.hasAttribute("md-list-item"),getPossibleItems:()=>this.slotItems,isRtl:()=>getComputedStyle(this).direction==="rtl",deactivateItem:t=>{t.tabIndex=-1},activateItem:t=>{t.tabIndex=0},isNavigableKey:t=>d.has(t),isActivatable:t=>!t.disabled&&t.type!=="text"}),this.internals=this.attachInternals(),this.internals.role="list",this.addEventListener("keydown",this.listController.handleKeydown)}render(){return r`
      <slot
