import{i as e}from"./preload-helper-xPQekRTU.js";import{T as t,b as n,h as r,n as i,t as a,u as o}from"./static-html-JNahc6jH.js";import{I as s,L as c,_ as l,j as u}from"./list-navigation-helpers-C1Ibc9kd.js";import{n as d,t as f}from"./OscdIcon-BLAkUGod.js";import{n as p,t as m}from"./OscdOutlinedField-Hq4cYrYZ.js";import{n as h,t as g}from"./OscdIconButton-De0GC20a.js";import{n as _,t as v}from"./decorate-DTsqE9Ek.js";import{n as y}from"./oscd-menu-item-CTcQZDW2.js";import{n as b,t as x}from"./getStorybookMeta-B4IvGxX7.js";import{a as S,i as C,o as w,r as T}from"./OscdOutlinedTextField-G3b_RTSj.js";import{n as E,t as D}from"./shared-styles-BCeUp4DX.js";import{t as O}from"./oscd-icon-button-CvGQfHP-.js";import{t as k}from"./oscd-outlined-text-field-D_zyV01x.js";function A(){return n`<oscd-icon slot="leading-icon">search</oscd-icon>`}var j,M=e((()=>{C(),o(),l(),S(),D(),_(),j=class extends T{constructor(){super(),this.clearLabel=`Clear search`,this.addEventListener(`focus`,this.handleFocus.bind(this)),this.addEventListener(`blur`,this.handleBlur.bind(this))}handleFocus(){this.placeholder=``}handleBlur(){this.placeholder=`Search`}willUpdate(e){super.willUpdate(e),this.hasLeadingIcon=!0,this.hasTrailingIcon=this.hasCustomSlot(`trailing-icon`)||!!this.value}clear(){this.value=``,this.dispatchEvent(new InputEvent(`input`,{bubbles:!0,composed:!0})),this.focus()}renderDefaultClearFieldIconButton(){return this.value?n`<oscd-icon-button
