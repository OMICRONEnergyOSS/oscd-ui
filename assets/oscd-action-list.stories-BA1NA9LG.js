import{x as e,a as y}from"./iframe-BFpCwY9R.js";import{b as r,n as f}from"./list-item-styles-Bfc4eJrR.js";import{O as A}from"./OscdMenu-DiyKsDkl.js";import{O as I,a as C,I as S}from"./OscdListItem-B_3Vgj5Y.js";import{O as b}from"./OscdDivider-Bq-VYPqG.js";import{O}from"./OscdList-XsnvtwlT.js";import{O as w}from"./OscdMenuItem-DnbnThgq.js";import{O as E}from"./OscdOutlinedTextField-C_3bodT-.js";import{F as T}from"./FilterListBase-u3mEvX3v.js";import{g as G}from"./getStorybookMeta-gDO-wW0N.js";import"./preload-helper-PPVm8Dsz.js";import"./menu-Ckp9SIHo.js";import"./style-map-BGd_K8UZ.js";import"./query-assigned-nodes-Ud0G1qU0.js";import"./shared-styles-DKww1ZEb.js";import"./redispatch-event-D1qO1AWI.js";import"./validator-C3KVGDlf.js";import"./form-associated-qER_3PrR.js";import"./on-report-validity-DiIWBLfR.js";import"./OscdOutlinedField-BfnWYMBB.js";import"./shared-styles-Dp4Khk2d.js";import"./getStorybookHelpers-cc4YvQDR.js";import"./oscd-menu-item-COy5XFsF.js";var _=Object.defineProperty,$=(s,t,i,o)=>{for(var c=void 0,h=s.length-1,g;h>=0;h--)(g=s[h])&&(c=g(t,i,c)||c);return c&&_(t,i,c),c};function n(s){return`${s.headline} ${s.supportingText??""}${s.filtergroup?.join(" ")??""}`}const m=class m extends T{constructor(){super(...arguments),this.items=[],this.height=72}renderMoreVertItem(t){t.actions.shift();const i=t.actions;return e`
...
${t.headline&&t.supportingText?"-":""}${t.supportingText}"
      ...
      </section>`}};m.scopedElements={"oscd-outlined-text-field":E,"oscd-icon":C,"oscd-list":O,"oscd-list-item":I,"oscd-divider":b,"oscd-menu":A,"oscd-menu-item":w},m.styles=y`
    section {
      display: flex;
...
</SCL>`,"application/xml"),{args:L,argTypes:u,meta:R}=G({tagName:"oscd-action-list"}),nt={...R,title:"Action Controls/Action List",tags:["autodocs"],argTypes:{...u,startingIcon:{control:{type:"select",options:["arrow-up","arrow-down","loading"]},description:"Name of icon to place at start of Action Item"},endingIcon:{control:{type:"string",options:["arrow-up","arrow-down","loading"]},description:"Name of icon to place at end of Action Item"},divider:{control:{type:"boolean"},description:"Add a divider at the bottom of the item"},filterGroup:{control:{type:"object"},description:"Specifies additional filter terms "},primaryAction:{control:{type:"boolean"},description:"The action to be performed when clicking the list item"},actionsCount:{control:{type:"number",min:0,max:4},description:"Number of list items to render. These are additional actions for the item. The first action is visible, the rest are in a context menu.",defaultValue:2}}},F=s=>{x("primaryAction")({item:s})},M=["add","edit","delete","content_copy"].map(s=>({icon:s,callback:t=>x(`action:${s}`)(t)})),v=(s,t)=>Array.from(k.querySelectorAll("GSEControl")).map(i=>({headline:i.getAttribute("name")??"unknown",...t?{supportingText:i.getAttribute("desc")}:{},attachedElement:i,startingIcon:s.startingIcon,endingIcon:s.endingIcon,divider:s.divider??!0,filtergroup:s.filterGroup?s.filterGroup:void 0,primaryAction:F,actions:M.slice(0,s.actionsCount)})),p={...L,primaryAction:!0,actionsCount:4,filterable:!1},a={argTypes:u,args:{...p,".items":v(p)}},l={argTypes:u,args:{...p,".items":v(p,!0)}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  argTypes,
  args: {
    ...defaultArgs,
...
}`,...l.parameters?.docs?.source}}};const ct=["Default","WithSupportingText"];export{a as Default,l as WithSupportingText,ct as __namedExportsOrder,nt as default};
