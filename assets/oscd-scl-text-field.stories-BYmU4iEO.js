import{i as $,x as n,a as v}from"./iframe-CzfB892c.js";import{S,n as r,a as x}from"./list-navigation-helpers-CWtHtHq2.js";import{O as T,r as y}from"./OscdIcon-D6gSxZ3c.js";import{O as w}from"./OscdIconButton-u3FIKm3J.js";import{O as N}from"./OscdMenu-D1YB7X1r.js";import{O as F}from"./OscdMenuItem-DA-1vXHl.js";import{O}from"./OscdSwitch-DyTZUMZU.js";import{O as E}from"./OscdFilledTextField-C-bsU2yu.js";import{o as s}from"./if-defined-Dskk7qFc.js";import{g as V}from"./getStorybookMeta-DOS5upft.js";import"./preload-helper-PPVm8Dsz.js";import"./shared-styles-ChfmohU1.js";import"./is-rtl-DJNyvqXe.js";import"./style-map-e5XHfPGA.js";import"./menuItemController-B_J_C6eD.js";import"./query-assigned-nodes-CLgeST5H.js";import"./redispatch-event-D1qO1AWI.js";import"./validator-DNzAhO9h.js";import"./form-associated-BTVmRIpu.js";import"./checkbox-validator-Dh2QDM13.js";import"./shared-styles-D7RceSw8.js";import"./on-report-validity-Bx-7rykv.js";import"./OscdFilledField-BaXdVLxT.js";import"./shared-styles-Csz4B7L3.js";import"./getStorybookHelpers-Bv3ZIOVO.js";import"./oscd-menu-item-Bv29e9fa.js";import"./oscd-filled-button-DQw484Ye.js";import"./OscdList-ZIhvBfgq.js";import"./oscd-list-item-C0ScTv6k.js";import"./OscdListItem-aUMQlSYk.js";import"./list-item-styles-Bz0C6iu4.js";var L=Object.defineProperty,M=Object.getOwnPropertyDescriptor,i=(b,e,l,p)=>{for(var o=p>1?void 0:p?M(e,l):e,h=b.length-1,m;h>=0;h--)(m=b[h])&&(o=(p?m(e,l,o):m(o))||o);return p&&o&&L(e,l,o),o};const c=class c extends S($){constructor(){super(...arguments),this.nullable=!1,this.textFieldValue="",this.disabled=!1,this.label="",this.required=!1,this.error=!1,this.suffixText="",this.placeholder="",this.type="text",this.pattern="",this.max="",this.min="",this.maxLength=-1,this.minLength=-1,this.unit="",this.multiplierIndex=0,this.multipliers=[null,""],this.isNull=!1}set value(e){e===null?this.null=!0:(this.null=!1,this.textFieldValue=e)}get value(){return this.null?null:this.textFieldValue}get multiplier(){return this.unit===""?null:this.multipliers[this.multiplierIndex]??this.multipliers[0]??null}set multiplier(e){const l=this.multipliers.indexOf(e);l>=0&&(this.multiplierIndex=l),this.suffixText=(this.multiplier??"")+this.unit}get null(){return this.nullable&&this.isNull}set null(e){!this.nullable||e===this.isNull||(this.isNull=e)}reportValidity(){return this.textField.reportValidity()}setCustomValidity(e){this.textField?.setCustomValidity(e)}checkValidity(){return this.textField.checkValidity()}reset(){return this.textField.reset()}selectMultiplier(e){let l=e.detail.initiator.querySelector(":scope > div")?.textContent??null;l==="No multiplier"&&(l=null),l!==void 0&&(this.multiplier=l)}renderMultiplierList(){return n`${this.multipliers.map(e=>{const l=e===null?"No multiplier":e;return n`<oscd-menu-item
