...
export abstract class TextField extends textFieldBaseClass {
    ...
    if (this.type === 'textarea') {
      return html`
        <textarea
          ...
          ?disabled=${this.disabled}
          maxlength=${ifDefined(hasMaxLength ? this.maxLength : undefined)}
          minlength=${ifDefined(hasMinLength ? this.minLength : undefined)}
  ...
  private getInputOrTextarea() {
    if (!this.inputOrTextarea) {
      ...
      // e.g.
      // const textField = document.createElement('oscd-outlined-text-field');
