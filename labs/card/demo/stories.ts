...
const withActions: MaterialStoryInit<StoryKnobs> = {
  ...
  render() {
    return html`
      <div class="container oscd-typescale-body-medium">
        <oscd-elevated-card class="card">
          <img src=${MEDIA_IMAGE} alt="Placeholder image" />
          <div class="content">
            An elevated card with actions
            <oscd-filled-button>Card action</oscd-filled-button>
          </div>
        </oscd-elevated-card>
