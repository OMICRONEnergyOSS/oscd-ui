...
const tabBaseClass = mixinFocusable(ScopedElementsMixin(LitElement));
...
export class Tab extends tabBaseClass {
  ...
  /**
   * The attribute `oscd-tab` indicates that the element is a tab for the parent
   * element, `<oscd-tabs>`. Make sure if you're implementing your own `oscd-tab`
   * component that you have an `oscd-tab` attribute set.
   */
  @property({ type: Boolean, reflect: true, attribute: 'oscd-tab' })
  readonly isTab = true;
  ...
  protected override render() {
    ...
    >
      ...
      <oscd-ripple .control=${this}></oscd-ripple>
      <div
