...
export class ListItemEl extends listItemBaseClass implements ListItem {
  ...
  /**
   * READONLY. Sets the `oscd-list-item` attribute on the element.
   */
  @property({ type: Boolean, attribute: 'oscd-list-item', reflect: true })
  isListItem = true;
  ...
  protected onFocusRingVisibilityChanged(_e: Event) {}
